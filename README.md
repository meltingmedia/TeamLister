...
TeamLister is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/TeamLister.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory TeamLister is now in, and do this:
...
Now, you'll want to change references to TeamLister in the files in your
new copied-from-TeamLister repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'TeamLister' to whatever the
name of your component is.

## Copyright Information

TeamLister is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of TeamLister the ability to modify, distribute
